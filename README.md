...
В продукционном профиле `postgres` и в профиле `test` эти пользователи не создаются, что упрощает написание интеграционных тестов.
...
поэтому стили пересобираются при каждом сохранении исходников.
