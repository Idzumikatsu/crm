...
| `SSL_CERT` | _(contents of crm-synergy.crt)_ | `.github/workflows/deploy.yml` | secrets/vars |
| `SSL_KEY` | _(contents of crm-synergy.key)_ | `.github/workflows/deploy.yml` | secrets/vars |
